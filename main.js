...
sr.reveal('.about-description', { delay: 400, origin: 'top' })
sr.reveal('.about-img', { delay: 400, origin: 'top' })
sr.reveal('.reviews-container .single-review', { delay: 400, origin: 'top' })
sr.reveal('.newsLetter-container', { delay: 400, origin: 'bottom' })
sr.reveal('.copytop-icons .bx', { delay: 800, origin: 'top' })